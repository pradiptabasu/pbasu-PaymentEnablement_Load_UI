...
public class configurationParameters {
    ...
    static {
        ...
        try {
            prop = new Properties();
            is = ClassLoader.class.getResourceAsStream("/Resources/configurationParameters.properties");
            is1 = ClassLoader.class.getResourceAsStream("/Resources/PaymentsEnablement_ISA_final_load.csv");
            prop.load(is);
